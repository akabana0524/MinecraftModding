package jp.wanda.minecraft.bouyomi;
...
public class mod_WandaBouyomi extends WandaModBase implements IChatListener,
	...
	public class EventHook {
		...
		public void recieveEvent(Event event) {
			...
			if (event instanceof LivingSpecialSpawnEvent) {
				LivingSpecialSpawnEvent spawn = (LivingSpecialSpawnEvent) event;
	...
	public void init(FMLInitializationEvent event) {
		...
		bouyomi = new BouyomiChan4J(propertyHost.value, propertyPort.getInt());
